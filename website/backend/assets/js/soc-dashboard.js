...
jQuery(function ($) {
    ...
    /*--------------------------------
        Rickshaw charts
     --------------------------------*/
    CMPLTADMIN_SETTINGS.dbRickshawChart = function () {
    ...
    CMPLTADMIN_SETTINGS.dbGaugemeter = function () {
        ...
        if ($("#gauge-meter").length) {
            var opts = {
                ...
                colorStart: '#673AB7', // Colors
                colorStop: '#673AB7', // just experiment with them
    ...
    $(document).ready(function () {
        ...
        //CMPLTADMIN_SETTINGS.dbRickshawChart();
        //CMPLTADMIN_SETTINGS.dbGaugemeter();
    });
