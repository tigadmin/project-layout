...
jQuery(function ($) {
    ...
    /*--------------------------------
        Chart Js Chart
     --------------------------------*/
    CMPLTADMIN_SETTINGS.RickshawChart = function () {
        ...
        if ($("#chart").length) {
            ...
            var graph = new Rickshaw.Graph({
                ...
                series: [{
                    color: '#3F51B5',
                    data: seriesData[0],
                    name: 'PG: Jeremy Lin (DAL)'
                }, {
                    color: '#FFC107',
                    data: seriesData[1],
                    name: 'PG: Matt Brooks (DAL)'
                }, {
                    color: '#673AB7',
                    data: seriesData[2],
                    name: 'PG: Paul Smith (DAL)'
                }, {
                    color: '#E91E63',
                    data: seriesData[3],
                    name: 'PG: Rob Smith (DAL)'
                }, {
                    color: '#a9a9a9',
                    data: seriesData[4],
                    name: 'PG: Lebron James (CLE)'
                }]
            });
    ...
    $(window).load(function () {
        CMPLTADMIN_SETTINGS.RickshawChart();
    });
