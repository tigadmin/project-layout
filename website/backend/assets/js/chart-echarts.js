...
// Initialize after dom ready
            ...
            var option = {
                ...
                xAxis: [{
                    type: 'category',
                    boundaryGap: false,
                    data: ['DraftKings-06-01', 'DraftKings-05-01', 'DraftKings-04-01', 'DraftKings-03-01', 'DraftKings-02-01'],
                    axisLine: {
                        show: true,
                        onZero: true,
                        lineStyle: {
                        ...
                        series: [
                            {
                                ...
                                data: [{value: 35, name: 'NFL'}, {value: 16, name: 'NBA'}, {value: 27, name: 'MLB'}]
                            }
                        ]
                    },
                    {
                        series: [
                            {
                                name: '05-16',
                                type: 'pie',
                                data: [{value: 42, name: 'NFL'}, {value: 51, name: 'NBA'}, {value: 39, name: 'MLB'}]
                            }
                        ]
                    },
                    {
                        series: [
                            {
                                name: '04-16',
                                type: 'pie',
                                data: [{value: 29, name: 'NFL'}, {value: 16, name: 'NBA'}, {value: 24, name: 'MLB'}]
                            }
                        ]
                    },
...
// Initialize after dom ready
            ...
            var option = {
                ...
                xAxis: [{
                    type: 'category',
                    boundaryGap: false,
                    data: ['DraftKings-06-01', 'DraftKings-05-01', 'DraftKings-04-01', 'DraftKings-03-01', 'DraftKings-02-01', 'DraftKings-01-01', 'Fanduel-12-01', 'Fanduel-11-01', 'Fanduel-10-01', 'Fanduel-09-01'],
                    axisLine: {
                        show: true,
                        onZero: true,
                        lineStyle: {
                        ...
                        series: [
                            {
                                ...
                                data: [{value: 35, name: 'NFL'}, {value: 16, name: 'NBA'}, {
                                    value: 27,
                                    name: 'MLB'
                                }, {value: 29, name: ''}, {value: 12, name: ''}]
                            }
                        ]
                    },
                    {
                        series: [
                            {
                                name: '05-16',
                                type: 'pie',
                                data: [{value: 42, name: 'NFL'}, {value: 51, name: 'NBA'}, {
                                    value: 39,
                                    name: 'MLB'
                                }, {value: 25, name: ''}, {value: 9, name: ''}]
                            }
                        ]
                    },
                    {
                        series: [
                            {
                                name: '04-16',
                                type: 'pie',
                                data: [{value: 29, name: 'NFL'}, {value: 16, name: 'NBA'}, {
                                    value: 24,
                                    name: 'MLB'
                                }, {value: 19, name: ''}, {value: 5, name: ''}]
                            }
                        ]
                    },
