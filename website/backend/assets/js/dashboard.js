                    ...
                    series: [
                        {
                            ...
                            data: [{value: 35, name: 'Apple'}, {value: 16, name: 'Windows'}, {
                                value: 27,
                                name: 'Linux'
                            }, {value: 29, name: 'Android'}, {value: 12, name: 'Others'}]
                        }
                    ]
                },
                {
                    series: [
                        {
                            name: '05-16',
                            type: 'pie',
                            data: [{value: 42, name: 'Apple'}, {value: 51, name: 'Windows'}, {
                                value: 39,
                                name: 'Linux'
                            }, {value: 25, name: 'Android'}, {value: 9, name: 'Others'}]
                        }
                    ]
                },
                {
                    series: [
                        {
                            name: '04-16',
                            type: 'pie',
                            data: [{value: 29, name: 'Apple'}, {value: 16, name: 'Windows'}, {
                                value: 24,
                                name: 'Linux'
                            }, {value: 19, name: 'Android'}, {value: 5, name: 'Others'}]
                        }
                    ]
                },
